...
export const metadata: Metadata = {
  title: 'Entrümpelung Telgte – Schnell & Zuverlässig | Collectus',
  description: 'Entrümpelung Telgte – zwischen Münster und Warendorf an der Ems. Festpreis, besenreine Übergabe, kostenlose Besichtigung.',
  alternates: { canonical: '/entruempelung-telgte' },
}

const scope = [
  'Entrümpelung einzelner Räume oder ganzer Gebäude',
  'Telgte-Zentrum und Westbevern',
  ...
  return (
    <>
      ...
      <PageHero
        ...
        highlight="Telgte"
        description="Schnelle, zuverlässige Entrümpelung für Privat und Gewerbe in Telgte. Wir räumen auf und entsorgen fachgerecht."
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-2 gap-14 items-start">
          <div>
            <span className="text-primary font-semibold text-sm tracking-wider uppercase">Telgte & Umgebung</span>
            <h2 className="font-heading text-3xl font-black text-gray-900 mt-2 mb-6">
              Ihr Entrümpelungsservice in Telgte
            </h2>
            <p className="text-gray-500 leading-relaxed mb-8">
              Telgte liegt im Kreis Warendorf, direkt zwischen Münster und unserem Standort in Ahlen.
              Collectus entrümpelt Ihre Immobilie in Telgte schnell, gründlich und zum Festpreis.
            </p>
          ...
          <div className="bg-gradient-to-br from-primary-50 via-white to-primary-100 rounded-3xl p-8 border border-primary/10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Privat & Gewerbe · Telgte + Region</p>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="font-heading text-2xl sm:text-3xl font-black text-gray-900 mb-6">
            Entrümpelung Telgte – fair, pünktlich und besenrein
          </h2>
          <div className="space-y-4 text-gray-600 leading-relaxed">
            <p>
              Telgte und die umliegenden Ortschaften gehören zu unserem festen Einsatzgebiet. Wir sind
              schnell vor Ort, erstellen ein transparentes Festpreisangebot und erledigen alles sauber.
            </p>
            <p>
              Besenreine Übergabe inklusive – egal ob Privat oder Gewerbe, Klein oder Groß.
            </p>
          </div>
          <div className="mt-10 flex flex-wrap gap-2">
            <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 rounded-full px-3 py-1.5 text-xs font-medium text-gray-500">
              <MapPinIcon className="w-3 h-3" />Entrümpelung Telgte
            </span>
            <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 rounded-full px-3 py-1.5 text-xs font-medium text-gray-500">
              <MapPinIcon className="w-3 h-3" />Entrümpelungsfirma Telgte
            </span>
            <Link href="/haushaltsaufloesung" className="inline-flex items-center gap-1.5 bg-white border border-gray-200 rounded-full px-3 py-1.5 text-xs font-medium text-gray-500 hover:border-primary/30 hover:text-primary transition-colors">
              <MapPinIcon className="w-3 h-3" />Haushaltsauflösung Telgte
            </Link>
            <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 rounded-full px-3 py-1.5 text-xs font-medium text-gray-500">
