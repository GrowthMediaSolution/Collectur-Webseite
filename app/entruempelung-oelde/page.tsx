  ...
  return (
    <>
      ...
      <PageHero
        ...
        highlight="Oelde"
        description="Schnelle, zuverlässige Entrümpelung für Privat und Gewerbe in Oelde. Wir räumen auf und entsorgen fachgerecht."
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-2 gap-14 items-start">
          <div>
            <span className="text-primary font-semibold text-sm tracking-wider uppercase">Oelde & Umgebung</span>
            <h2 className="font-heading text-3xl font-black text-gray-900 mt-2 mb-6">
              Ihr Entrümpelungsservice in Oelde
            </h2>
            <p className="text-gray-500 leading-relaxed mb-8">
              Oelde liegt im Herzen des Münsterlandes – und mitten in unserem Einsatzgebiet. Collectus
              übernimmt Ihre Entrümpelung in Oelde schnell, gründlich und zum fairen Festpreis.
            </p>
          ...
          <div className="bg-gradient-to-br from-primary-50 via-white to-primary-100 rounded-3xl p-8 border border-primary/10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Privat & Gewerbe · Oelde + Region</p>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="font-heading text-2xl sm:text-3xl font-black text-gray-900 mb-6">
            Entrümpelung Oelde – fair, pünktlich und besenrein
          </h2>
          <div className="space-y-4 text-gray-600 leading-relaxed">
            <p>
              Oelde und Ahlen sind Nachbarstädte – wir sind entsprechend schnell vor Ort. Unser Team
              entrümpelt zuverlässig und hinterlässt die Räume besenrein.
            </p>
            <p>
              Ob Wohnung, Haus oder Gewerbeobjekt – wir erstellen nach kostenloser Besichtigung ein
              verbindliches Festpreisangebot und erledigen alles termingerecht.
            </p>
          </div>
