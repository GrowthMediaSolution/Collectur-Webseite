...
export const metadata: Metadata = {
  title: 'Sperrmüll-Ratgeber: Was darf in den Sperrmüll? | Collectus',
  ...
  alternates: { canonical: '/sperrmuell-ratgeber' },
}
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { href: '/elektroschrott-entsorgung', label: 'Elektroschrott' },
