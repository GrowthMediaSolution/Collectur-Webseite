  ...
  return (
    <>
      ...
      <PageHero
        ...
        highlight="Werne"
        description="Schnelle, zuverlässige Entrümpelung für Privat und Gewerbe in Werne. Wir räumen auf und entsorgen fachgerecht."
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-2 gap-14 items-start">
          <div>
            <span className="text-primary font-semibold text-sm tracking-wider uppercase">Werne & Umgebung</span>
            <h2 className="font-heading text-3xl font-black text-gray-900 mt-2 mb-6">
              Ihr Entrümpelungsservice in Werne
            </h2>
            <p className="text-gray-500 leading-relaxed mb-8">
              Werne liegt im Kreis Unna und gehört zu unserem Einsatzgebiet. Collectus übernimmt Ihre
              Entrümpelung in Werne professionell, pünktlich und zum fairen Festpreis.
            </p>
          ...
          <div className="bg-gradient-to-br from-primary-50 via-white to-primary-100 rounded-3xl p-8 border border-primary/10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Privat & Gewerbe · Werne + Region</p>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="font-heading text-2xl sm:text-3xl font-black text-gray-900 mb-6">
            Entrümpelung Werne – fair, pünktlich und besenrein
          </h2>
          <div className="space-y-4 text-gray-600 leading-relaxed">
            <p>
              Werne und die umliegenden Ortschaften im Kreis Unna sind feste Bestandteile unseres
              Einsatzgebiets. Wir sind schnell vor Ort und bieten professionelle Entrümpelung zu fairen Preisen.
            </p>
            <p>
              Kostenlose Besichtigung, verbindliches Festpreisangebot, besenreine Übergabe –
              alles aus einer Hand, ohne Überraschungen.
            </p>
          </div>
