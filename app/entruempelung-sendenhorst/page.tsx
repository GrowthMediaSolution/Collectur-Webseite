  ...
  return (
    <>
      ...
      <PageHero
        ...
        description="Schnelle, zuverlässige Entrümpelung für Privat und Gewerbe in Sendenhorst. Wir räumen auf und entsorgen fachgerecht."
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-2 gap-14 items-start">
          <div>
            <span className="text-primary font-semibold text-sm tracking-wider uppercase">Sendenhorst & Umgebung</span>
            <h2 className="font-heading text-3xl font-black text-gray-900 mt-2 mb-6">
              Ihr Entrümpelungsservice in Sendenhorst
            </h2>
            <p className="text-gray-500 leading-relaxed mb-8">
              Sendenhorst liegt im Kreis Warendorf und ist von Ahlen aus schnell erreichbar. Collectus
              übernimmt Ihre Entrümpelung professionell, pünktlich und zum Festpreis.
            </p>
          ...
          <div className="bg-gradient-to-br from-primary-50 via-white to-primary-100 rounded-3xl p-8 border border-primary/10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Privat & Gewerbe · Sendenhorst + Region</p>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="font-heading text-2xl sm:text-3xl font-black text-gray-900 mb-6">
            Entrümpelung Sendenhorst – fair, pünktlich und besenrein
          </h2>
          <div className="space-y-4 text-gray-600 leading-relaxed">
            <p>
              Sendenhorst und die umliegenden Ortschaften sind regelmäßige Einsatzgebiete für unser Team.
              Wir kommen zur kostenlosen Besichtigung und geben Ihnen ein verbindliches Festpreisangebot.
            </p>
            <p>
              Besenreine Übergabe, fachgerechte Entsorgung, kurzfristige Termine – alles aus einer Hand.
            </p>
          </div>
