  ...
  return (
    <>
      ...
      <PageHero
        ...
        highlight="Lippstadt"
        description="Schnelle, zuverlässige Entrümpelung für Privat und Gewerbe in Lippstadt. Wir räumen auf und entsorgen fachgerecht."
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-2 gap-14 items-start">
          <div>
            <span className="text-primary font-semibold text-sm tracking-wider uppercase">Lippstadt & Umgebung</span>
            <h2 className="font-heading text-3xl font-black text-gray-900 mt-2 mb-6">
              Ihr Entrümpelungsservice in Lippstadt
            </h2>
            <p className="text-gray-500 leading-relaxed mb-8">
              Collectus übernimmt Entrümpelung in Lippstadt und dem Kreis Soest. Zuverlässig, pünktlich,
              besenrein. Kostenlose Besichtigung, Festpreis, keine versteckten Kosten.
            </p>
          ...
          <div className="bg-gradient-to-br from-primary-50 via-white to-primary-100 rounded-3xl p-8 border border-primary/10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Privat & Gewerbe · Lippstadt + Region</p>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="font-heading text-2xl sm:text-3xl font-black text-gray-900 mb-6">
            Entrümpelung Lippstadt – fair, pünktlich und besenrein
          </h2>
          <div className="space-y-4 text-gray-600 leading-relaxed">
            <p>
              Lippstadt liegt im Kreis Soest und gehört zu unserem regulären Einsatzgebiet. Wir sind schnell
              vor Ort und bieten Entrümpelungen für Privathaushalte und Gewerbeobjekte an.
            </p>
            <p>
              Kein Aufwand für Sie: Wir kommen zur Besichtigung, erstellen ein Festpreisangebot und erledigen
              alles – inklusive Entsorgung und besenreiner Übergabe.
            </p>
          </div>
