  ...
  return (
    <>
      ...
      <PageHero
        ...
        seoTitle="Messie-Entrümpelung Ahlen – Diskret & Professionell | Collectus"
        seoDescription="Diskrete Messie-Entrümpelung in Ahlen und Umgebung. Professionelle Räumung, Grundreinigung, fachgerechte Entsorgung. Vertraulich und respektvoll."
      />
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { to: '/nachlassentruempelung', label: 'Nachlassentrümpelung' },
