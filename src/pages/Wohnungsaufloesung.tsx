  ...
  return (
    <>
      ...
      <PageHero
        ...
        seoTitle="Wohnungsauflösung Ahlen – Komplett & Besenrein | Collectus"
        seoDescription="Professionelle Wohnungsauflösung in Ahlen und Umgebung. Kostenlose Besichtigung, besenreine Übergabe, Festpreisgarantie. Jetzt unverbindlich anfragen!"
      />
