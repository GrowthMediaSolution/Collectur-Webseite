  ...
  return (
    <>
      ...
      <PageHero
        ...
        seoTitle="Gartenräumung Ahlen – Gartenhaus & Schuppen räumen | Collectus"
        seoDescription="Gartenräumung in Ahlen und Umgebung. Gartenhaus, Schuppen, Terrasse – professionell geräumt und fachgerecht entsorgt."
      />
