  ...
  return (
    <>
      ...
      <PageHero
        ...
        seoTitle="Elektroschrott Entsorgung Ahlen – Abholung & Recycling | Collectus"
        seoDescription="Elektroschrott fachgerecht entsorgen in Ahlen. Wir holen alte Elektrogeräte ab und recyceln umweltgerecht. Schnell und unkompliziert."
      />
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { to: '/gewerbeentruempelung', label: 'Gewerbeentrümpelung' },
