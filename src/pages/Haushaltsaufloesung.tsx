  ...
  return (
    <>
      ...
      <PageHero
        ...
        seoTitle="Haushaltsauflösung Ahlen – Einfühlsam & Professionell | Collectus"
        seoDescription="Komplette Haushaltsauflösung in Ahlen. Einfühlsam und besenrein – nach Todesfall, Pflegeheim oder Umzug. Kostenlose Besichtigung, Festpreis."
      />
