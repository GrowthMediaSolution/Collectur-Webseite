  ...
  return (
    <>
      ...
      <PageHero
        ...
        seoTitle="Möbel entsorgen Ahlen – Altmöbel Abholung | Collectus"
        seoDescription="Alte Möbel entsorgen in Ahlen. Abholung, Demontage und fachgerechte Entsorgung. Schnell, günstig und umweltgerecht."
      />
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { to: '/elektroschrott-entsorgung', label: 'Elektroschrott-Entsorgung' },
